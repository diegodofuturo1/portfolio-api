...
export class PortfolioService {
  ...
  async updateEducation(id: string, education: EducationDto, userId: string): Promise<Education> {
    ...
    return await this.commandBus.execute(
      new UpdateEducationCommand(_education, { ...education, id, userId }),
    );
  }
  ...
  async updateExperience(
    ...
    return await this.commandBus.execute(
      new UpdateExperienceCommand(_experience, { ...experience, id, userId }),
    );
  }
  ...
  async updatePortfolio(id: string, portfolio: PortfolioDto, userId: string): Promise<Portfolio> {
    ...
    return await this.commandBus.execute(
      new UpdatePortfolioCommand(_portfolio, { ...portfolio, id, userId }),
    );
  }
